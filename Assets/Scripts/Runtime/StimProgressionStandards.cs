...
namespace StimTycoon.Runtime
{
    ...
    /// </summary>
    public static class StimProgressionStandards
    {
        ...
        public static StimCoreStatBand GetCoreStatBand(int value)
        {
            if (value < LowCoreStatStartsAt) return StimCoreStatBand.Critical;
            if (value < StableCoreStatStartsAt) return StimCoreStatBand.Low;
            if (value < StrongCoreStatStartsAt) return StimCoreStatBand.Stable;
            if (value < ExceptionalCoreStatStartsAt) return StimCoreStatBand.Strong;
            if (value < PeakCoreStatStartsAt) return StimCoreStatBand.Exceptional;
            return StimCoreStatBand.Peak;
        }
