...
namespace StimTycoon.Tests.Domain.Content
{
    ...
    public sealed class StimFollowUpCatalogValidatorTests
    {
        [Test]
        public void CompleteAuthoredCatalog_HasReachableValidFollowUps()
        {
            var result = StimFollowUpCatalogValidator.Validate(CompleteCatalog());
        ...
        public void MissingFollowUpTarget_IsRejected()
        {
            ...
            var result = StimFollowUpCatalogValidator.Validate(events);
        ...
        private static List<StimEvent> CompleteCatalog()
        {
        ...
        private static ScheduledEventRef FirstFollowUp(IEnumerable<StimEvent> events)
        {
