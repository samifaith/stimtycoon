...
{
    public sealed class StimAlphaContentCoverageResult
    {
    ...
    public static class StimAlphaContentCoverage
    {
        ...
        public static StimAlphaContentCoverageResult Validate(IReadOnlyList<StimEvent> events)
        {
            var result = new StimAlphaContentCoverageResult();
        ...
        private static StimAlphaContentCoverageResult Fail(StimAlphaContentCoverageResult result, string error)
        {
            AddError(result, error);
            return result;
        }

        private static void AddError(StimAlphaContentCoverageResult result, string error)
        {
