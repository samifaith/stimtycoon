...
namespace StimTycoon.Events
{
    ...
    public sealed class StimEffectValueResolver : IStimEffectValueResolver
    {
        private static readonly IReadOnlyDictionary<string, float> Defaults =
            ...
            {
                { StimEffectValueRules.StagedStatGain, 1f },
                { StimEffectValueRules.StagedStatLoss, -1f },
                { StimEffectValueRules.StagedSkillXpGain, 1f },
                { StimEffectValueRules.StagedCareerProgressGain, 1f },
                { StimEffectValueRules.StagedCashSmallGain, 500f },
                { StimEffectValueRules.StagedCashMediumGain, 1000f },
                { StimEffectValueRules.StagedCashSmallCost, -500f }
            };
