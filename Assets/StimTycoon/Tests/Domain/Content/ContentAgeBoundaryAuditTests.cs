...
namespace StimTycoon.Tests.Domain.Content
{
    ...
    public sealed class ContentAgeBoundaryAuditTests
    {
        [Test]
            ...
            string eventId, int age, bool expected)
        {
            ...
            Assert.That(EventAgeEligibility.IsEligible(evt, age), Is.EqualTo(expected),
        ...
        private static IEnumerable<Event> CompleteCatalog()
        {
