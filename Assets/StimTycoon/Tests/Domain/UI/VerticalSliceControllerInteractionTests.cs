...
{
    public sealed class VerticalSliceControllerInteractionTests
    {
        private const string PlayableLifePath = "Assets/StimTycoon/UI/VerticalSlice.uxml";
        private GameObject host;
        private VerticalSliceController controller;
        ...
        public void SetUp()
        {
            ...
            controller = host.AddComponent<VerticalSliceController>();
            ...
            save.state.character.lifeStage = GameSessionService.GetLifeStage(18);
            save.state.education.stage = GameSessionService.GetEducationStage(18);
        ...
        {
            var evt = RepresentativeEvents.CreateSchoolGroupProject();
        ...
        public void FirstLifeOrientation_UsesOneFocusedScreenAndPersistsContinue()
        {
            ...
            session.ActiveSave.state.orientation = new OrientationState();
        ...
        public void LifeFeed_GroupsEntriesByMonthWithNewestMonthFirst()
        {
            ...
            session.ActiveSave.state.lifeFeed.Add(new LifeFeedEntry
        ...
        {
            session.ActiveSave.state.lifeFeed.Clear();
            var storedFirst = new LifeFeedEntry
            {
        ...
        public void PerformActivity_ShowsSignedFeedbackAndRefreshesVisibleState()
        {
            ...
            Invoke("PerformActivity", ActivityType.Study);
        ...
        public void AdvanceYear_ResumesRemainingMonthsAfterInterruptingEvent()
        {
            ...
            var repairEvent = RepresentativeEvents.CreateHomeDeferredMaintenance();
            ...
            Invoke("Resolve", "repair_now", PaymentMethod.Cash);
            Invoke("CloseEventSheet");
        ...
        {
            var catalog = new InMemoryEventCatalog();
            var review = RepresentativeEvents.CreateYearInReview();
            ...
            Invoke("Resolve", "invest_in_growth", PaymentMethod.Cash);
            Invoke("CloseEventSheet");
        ...
        public void SocialInteraction_UpdatesProfileAndShowsOutcomeOverlay()
        {
            ...
            Invoke("PerformRelationshipInteraction", RelationshipInteractionType.Talk);
        ...
        public void PartnerDetail_ShowsConsentGatedFamilyPlanningActions()
        {
            ...
            Invoke("PerformFamilyPlanning", FamilyPlanningAction.Discuss);
        ...
        {
            session.ActiveSave.state.family.children.Add(new ChildState
            {
            ...
            session.ActiveSave.state.relationships.Add(new RelationshipState
            {
            ...
            Invoke("PerformParentingAction", ParentingAction.Teach);
        ...
        public void EducationCard_ShowsLevelsLocksAndTransactionalProgress()
        {
            ...
            session.ActiveSave.state.character.lifeStage = GameSessionService.GetLifeStage(10);
            session.ActiveSave.state.education.stage = GameSessionService.GetEducationStage(10);
            ...
            Invoke("PerformEducationAction", EducationActionType.Read);
        ...
        public void EducationAction_ReopensPendingYearReviewInsteadOfShowingInternalId()
        {
            ...
            session.ActiveSave.state.character.lifeStage = GameSessionService.GetLifeStage(10);
            session.ActiveSave.state.education.stage = GameSessionService.GetEducationStage(10);
            session.ActiveSave.state.pendingEventId = RepresentativeEvents.YearInReviewId;
            Invoke("RefreshHeader");

            Invoke("PerformEducationAction", EducationActionType.Homework);

            Assert.That(root.Q<Label>("event-title").text,
                Is.EqualTo(RepresentativeEvents.CreateYearInReview().titleKey));
            Assert.IsFalse(root.Q("event-sheet").ClassListContains("hidden"));
            Assert.IsFalse(root.Q("choices").ClassListContains("hidden"));
            Assert.IsTrue(root.Q("result-card").ClassListContains("hidden"));
            Assert.That(root.Q<Label>("result-text").text,
                Does.Not.Contain(RepresentativeEvents.YearInReviewId));
        }
        ...
        public void EducationCard_PresentsAndCommitsRequiredSchoolPath()
        {
            ...
            session.ActiveSave.state.character.lifeStage = GameSessionService.GetLifeStage(15);
            ...
            Invoke("PerformSchoolPathChoice", SchoolPathChoice.VocationalTrack);
        ...
        public void EducationCard_PreviewsAndCommitsAffordableStudyTrack()
        {
            ...
            Invoke("PerformStudyTrackChoice", StudyTrack.Academic);
        ...
        public void StudySessionCard_OpensFocusedPreviewBeforeCommit()
        {
            ...
            Invoke("ShowStudySessionSheet", StudyDifficulty.Medium, definition);
            ...
            Assert.That(session.ActiveSave.state.actionProgress, Has.Some.Matches<ActionProgressState>(action =>
        ...
        {
            session.ActiveSave.state.career = new CareerState();
            Invoke("RefreshHeader");
            ...
            Invoke("PerformCareerAction", CareerActionType.Apply);
            ...
            Invoke("PerformCareerAction", CareerActionType.Interview);
        ...
        {
            session.ActiveSave.state.skills.Add(new SkillState
        ...
        public void FinalLifeSummary_AppearsWhenAnnualHealthDeclineEndsLife()
        {
            ...
            session.ActiveSave.state.character.lifeStage = GameSessionService.GetLifeStage(79);
        ...
        {
            session.ActiveSave.state.achievements.Add(new AchievementState
            {
        ...
        public void AgeGatedOptions_DoNotAppearBeforeTheyAreAgeAppropriate()
        {
            ...
            session.ActiveSave.state.character.lifeStage = GameSessionService.GetLifeStage(5);
            ...
            var setBankTab = typeof(VerticalSliceController).GetMethod(
        ...
        public void HomeCard_PreviewsAndRefreshesPersistedActionState()
        {
            ...
            Invoke("PerformHomeAction", HomeActionType.Read);
        ...
        {
            Invoke("ShowMoneyDestination");
            Invoke("SetBankTab", BankTab.Investing);
            Invoke("OpenShellModal", ShellModal.Event);
            Invoke("SetBankTab", BankTab.Savings);
        ...
        {
            SetField("gameSession", session);
            SetField("shellBinder", new ShellBinder(root, null));
            ...
            SetField("lifeBinder", new LifeBinder(root, feedTemplate));
            SetField("studyBinder", new StudyBinder(root));
            ...
            SetField("workBinder", new WorkBinder(root));
            SetField("bankBinder", new BankBinder(root));
            SetField("socialBinder", new SocialBinder(root));
            SetField("goalsBinder", new GoalsBinder(root, null));
            SetField("newLifeBinder", new NewLifeBinder(root));
            SetField("eventSheetBinder", new EventSheetBinder(root));
            SetField("finalLifeBinder", new FinalLifeBinder(root));
            SetField("homeBinder", new HomeBinder(root));
            SetField("matchBinder", new MatchBinder(root));
            SetField("lifeOverviewBinder", new LifeOverviewBinder(root));
        }

        private void SetField(string name, object value)
        {
            var field = typeof(VerticalSliceController).GetField(name, BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        private void UseSessionWithPendingYearReview()
        {
            ...
            var pendingSession = new GameSessionService(
                catalog,
                new MemorySaveRepository(),
                utcNow: () => DateTimeOffset.Parse("2026-07-13T20:00:00Z"));
            session.ActiveSave.state.pendingEventId = RepresentativeEvents.YearInReviewId;
        ...
        {
            var method = typeof(VerticalSliceController).GetMethod(name, BindingFlags.Instance | BindingFlags.NonPublic);
