...
namespace StimTycoon.Tests.PlayMode
{
    ...
    public sealed class M13VisualCaptureTests
    {
        ...
        public IEnumerator CaptureSixDestinationsAcrossM13Matrix()
        {
            ...
            var controller = Object.FindFirstObjectByType<VerticalSliceController>();
            ...
            try
            {
                ...
                foreach (var textScale in new[] { 1f, 1.3f })
                {
                    ...
                    controller = Object.FindFirstObjectByType<VerticalSliceController>();
                    Assert.That(document, Is.Not.Null);
                    Assert.That(controller, Is.Not.Null);
                    root = document.rootVisualElement;
                    Assert.That(root, Is.Not.Null);
                    VerticalSliceController.ApplyResponsiveLayout(root, profile.Width);
