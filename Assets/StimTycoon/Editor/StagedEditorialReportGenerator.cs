...
{
    public static class StagedEditorialReportGenerator
    {
        ...
        public static string Generate()
        {
            ...
            var catalog = StagedEventCatalog.CreateAllStagedEvents()
        ...
        private static string Render(
            IReadOnlyList<ReviewNode> nodes, IReadOnlyDictionary<string, Event> catalog)
        {
            var output = new StringBuilder();
            var effectValues = new EffectValueResolver();
