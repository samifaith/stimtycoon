...
{
    public static class RepresentativeEvents
    {
        ...
        public static IReadOnlyList<Event> CreateLaunchAlphaCatalog()
        {
        ...
        public static Event CreateAppliedFinanceChallenge() => CreateDisciplineChallenge(
        ...
        public static Event CreateCommunityHealthChallenge() => CreateDisciplineChallenge(
        ...
        public static Event CreateSustainableTradesChallenge() => CreateDisciplineChallenge(
        ...
        private static Event CreateDisciplineChallenge(
        ...
        public static Event CreateHomeDeferredMaintenance()
        {
            return new Event
            {
                ...
                ageRange = new AgeRange { minAge = 18, maxAge = 120 },
                locations = new List<string> { "USA", "Jamaica" },
        ...
        public static Event CreateYearInReview()
        {
            return new Event
            {
                id = YearInReviewId,
        ...
        public static Event CreateSalaryNegotiation()
        {
            return new Event
            {
        ...
        public static Event CreateHealthBurnout()
        {
            return new Event
            {
                id = HealthBurnoutId,
        ...
        public static Event CreateMoneyFastReturn()
        {
            return new Event
            {
        ...
        public static Event CreateSchoolGroupProject()
        {
            return new Event
            {
        ...
        public static Event CreateChildhoodGrownFolksTable()
        {
            return new Event
            {
                ...
                cooldownYears = 2,
                repeatPolicy = RepeatPolicy.OncePerLifeStage,
                analyticsTags = new List<string> { "childhood", "family", "money", "minor_cash_agency" },
                choices = new List<Choice>
                {
                    new Choice
                    {
        ...
        public static Event CreateRandomGain()
        {
            return new Event
            {
                id = RandomGainId,
        ...
        public static Event CreateRandomLoss()
        {
            return new Event
            {
                id = RandomLossId,
                ...
                ageRange = new AgeRange { minAge = 18, maxAge = 100 },
                locations = new List<string> { "USA", "Jamaica" },
                requirementsJson = "{}",
                cooldownYears = 1,
                repeatPolicy = RepeatPolicy.Repeatable,
        ...
        public static Event CreateRandomGainRefund()
        {
            return new Event
            {
        ...
        public static Event CreateRandomLossRepair()
        {
            return new Event
            {
        ...
        public static Event CreateLuckCrossroads()
        {
            return new Event
            {
                id = LuckCrossroadsId,
        ...
        public static Event CreateChildhoodDiscovery()
        {
            return new Event
            {
        ...
        public static Event CreateChildhoodComfort()
        {
            return new Event
            {
        ...
        public static Event CreatePeerTrustConflict()
        {
            return new Event
            {
        ...
        public static Event CreatePeerTrustAftermath()
        {
            return new Event
            {
        ...
        public static Event CreatePeerJealousy()
        {
            return new Event
            {
                id = PeerJealousyId,
        ...
        public static Event CreateComingOfAgeGender()
        {
            var evt = new Event
            {
        ...
        public static Event CreateComingOfAgeOrientation()
        {
            var evt = new Event
            {
        ...
        public static Event CreatePromInvitation()
        {
        ...
        public static Event CreateFirstKiss()
        {
            return new Event
            {
                id = FirstKissId,
        ...
        public static Event CreateProposal()
        {
        ...
        public static Event CreateWedding()
        {
            var evt = new Event
            {
                id = WeddingId,
        ...
        public static Event CreateMarriageCrossroads()
        {
            return new Event
            {
