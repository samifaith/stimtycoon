...
{
    public sealed class CareerRoleDefinition
    {
        public string title;
    ...
    public sealed class CareerIndustryDefinition
    {
        ...
        public IReadOnlyList<CareerRoleDefinition> roles;
    }
    ...
    public static class CareerCatalog
    {
        ...
        private static readonly IReadOnlyList<CareerIndustryDefinition> Industries =
            new List<CareerIndustryDefinition>
            {
                Create(FinanceIndustryId, "Finance", "stim_financial_group", string.Empty, 0,
                    "professional", 1,
                    Role("Junior Associate", 4000000, ProgressionStandards.FirstCareerPromotionProgress),
                    Role("Associate", 5500000, ProgressionStandards.SecondCareerPromotionProgress),
                    Role("Senior Associate", 7500000, ProgressionStandards.ThirdCareerPromotionProgress),
        ...
        public static IReadOnlyList<CareerIndustryDefinition> GetIndustries() => Industries;

        public static bool TryGetIndustry(string industryId, out CareerIndustryDefinition industry)
        {
            industry = null;
        ...
        public static bool TryGetNextRole(
            string industryId, string roleTitle, out CareerRoleDefinition nextRole, out int progressRequired)
        {
            nextRole = null;
            progressRequired = 0;
        ...
        public static bool TryGetApplicationRequirement(
            GameState state, string industryId, out string requirement)
        {
            ...
            var skillLevel = GameSessionService.GetSkillLevel(
                GameSessionService.GetSkillExperience(state?.skills, industry.requiredSkillId));
        ...
        private static CareerIndustryDefinition Create(
            string id, string name, string employer, string track, int xp, string skill, int level,
            params CareerRoleDefinition[] roles) => new CareerIndustryDefinition
        {
        ...
        private static CareerRoleDefinition Role(string title, long salary, int progress) =>
