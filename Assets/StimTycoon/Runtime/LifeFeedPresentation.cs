...
{
    public static class LifeFeedPresentation
    {
        public static List<LifeFeedEntry> GetNewestFirst(IReadOnlyList<LifeFeedEntry> entries)
        {
            var ordered = new List<LifeFeedEntry>();
        ...
        private static int CompareNewestFirst(LifeFeedEntry left, LifeFeedEntry right)
        {
