...
{
    public static class ActionAmountService
    {
            ...
            out string error)
        {
            ...
            var available = payment == ActionPaymentOption.Cash
                ? availableCashMinorUnits
                : payment == ActionPaymentOption.Credit ? availableCreditMinorUnits : 0;
            if (definition.costMinorUnits > available)
            {
                error = payment == ActionPaymentOption.Cash
                    ? "Not enough cash."
