...
{
    public sealed class NewLifeRequest
    {
    ...
    public static class NewLifeFactory
    {
            ...
            int seed)
        {
            ...
            return new SaveEnvelope
            {
                ...
                rng = new RngState { seed = seed, step = 0 },
                ...
                state = new GameState
                {
                    ...
                    finances = new FinancesState { cashMinorUnits = startingStats.cashMinorUnits },
                    career = new CareerState(),
                    education = new EducationState { stage = "not_started" },
                    household = new HouseholdState(),
                    relationships = new List<RelationshipState> { parents[0].relationship, parents[1].relationship },
                    lifeFeed = new List<LifeFeedEntry>
                    {
                        new LifeFeedEntry
                        {
                            entryId = "birth",
        ...
        private static ParentProfile CreateParent(string id, string name, int relationshipValue, Random random)
        {
            ...
            profile.relationship = new RelationshipState
            {
                relationshipId = id,
                displayName = name,
