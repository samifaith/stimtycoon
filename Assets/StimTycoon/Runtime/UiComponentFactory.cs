...
namespace StimTycoon.Runtime
{
    public static class UiComponentFactory
    {
            ...
            VisualTreeAsset template = null)
        {
            ...
            PresentationStateStyler.Apply(row,
                actionText == "CLAIM"
                    ? PresentationState.Claimable
                    : actionEnabled ? PresentationState.Available : PresentationState.Disabled);
            ...
            Action onOpen = null)
        {
            ...
            PresentationStateStyler.Apply(row,
                available ? PresentationState.Available : PresentationState.Locked);
        ...
        private static string ToCompactTimestamp(LifeFeedEntry entry)
        {
