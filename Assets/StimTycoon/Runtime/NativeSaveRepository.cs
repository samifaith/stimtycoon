...
namespace StimTycoon.Runtime
{
    ...
    /// </summary>
    public sealed class NativeSaveRepository : ISaveRepository
    {
        ...
        public NativeSaveRepository(string persistenceRoot = null)
        {
        ...
        public bool TryValidateSave(string serializedSave, out string validationSummary)
        {
            ...
            validationSummary = SaveValidator.GetValidationSummary(
                result,
            ...
            out string validationSummary)
        {
            ...
            return SaveMigrator.TryMigrate(
                serializedSave,
                out save,
                out _,
        ...
        private static bool HasVerifiableHash(SaveEnvelope save)
        {
            return save?.integrity?.payloadHash != null &&
                   save.integrity.payloadHash.StartsWith(Sha256Prefix, StringComparison.Ordinal);
        }

        private static string CalculatePayloadHash(SaveEnvelope save)
        {
