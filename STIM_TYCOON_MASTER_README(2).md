...
- **Phase 1 — Simulation Skeleton:** verified complete for the offline implementation. The 235-test run includes a deterministic birth-to-death harness that advances every month, resolves pending events, persists transactions, unlocks achievements, and reaches the final summary without developer intervention.
...
- [x] Establish a user-verified 235-test EditMode baseline, including seeded birth-to-ending, shared-action, timed-lifecycle, monetary-input, Education, Fitness, and Professional coverage.
