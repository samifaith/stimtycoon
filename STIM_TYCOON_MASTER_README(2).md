...
- **Phase 1 — Simulation Skeleton:** verified complete for the offline implementation. The 196-test run includes a deterministic birth-to-death harness that advances every month, resolves pending events, persists transactions, unlocks achievements, and reaches the final summary without developer intervention.
...
- [x] Establish a user-verified 196-test EditMode baseline, including seeded birth-to-ending, Money/manual-work, and expanded Phase 2 coverage.
