...
1. **M7 — Time, Year in Review, and annual rewards.** Ship Advance Year as safe sequential monthly transactions; stop for required input; summarize annual changes; present meaningful next-year choices; and grant one persisted, duplicate-safe, path-appropriate benefit after any completed twelve-month cycle.
2. **M8 — Money and banking.** Add transactional savings transfers, history, grounded interest/projections, cash-flow detail, credit repayment, reusable amount/payment controls, and responsible investing gates.
3. **M9 — Home and personal development.** Build one persistent home with room-object reading, training, rest, maintenance, household activities, visible costs/cooldowns, condition consequences, and a meaningful upgrade path.
4. **M10 — Relationships, dating, and family.** Add compatible-person discovery, deeper friendship/romance consequence chains, consent-aware family planning, pregnancy/adoption, children, parenting, and household consequences.
