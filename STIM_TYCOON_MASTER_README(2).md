...
- **Phase 1 — Simulation Skeleton:** verified complete for the offline implementation. The 232-test run includes a deterministic birth-to-death harness that advances every month, resolves pending events, persists transactions, unlocks achievements, and reaches the final summary without developer intervention.
...
- [x] Establish a user-verified 232-test EditMode baseline, including seeded birth-to-ending, shared-action, timed-lifecycle, monetary-input, and the complete first Education slice.
