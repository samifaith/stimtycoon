...
- [ ] W2 — validated data-driven definitions and exact Yarn-to-catalog event/choice parity tests are complete for all 100 staged Childhood/School/Career/Health/Money nodes. Automated audits cover event and non-event age boundaries, follow-up contracts, deterministic weighted selection, draft/duplicate prose, authored-copy completeness, and category-correct consequence language. Finish human editorial approval and gradual measured registration before random selection.
