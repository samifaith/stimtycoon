...
The approved shell has six destinations: **Life, Study, Work, Bank, Social, and Goals**. The alternate Home/School/Activities/City/Menu navigation, action-energy quotas, `End Turn`, Stim Coins, season XP, and premium resource loops shown in some references are not current Stim systems.
...
| Premium study module | Disabled, labeled placeholder only until a separately approved product exists | **Deferred** — no premium progression may be implied | COM-02 |
...
| Sponsored/rewarded slot | Stable disabled placeholder before service approval; unavailable/loading/declined/completed branches after approval | **Deferred** | COM-03 |
...
| Stim Coins | Premium balance and purchase shortcut | **Reference only/Deferred** — not a Stim resource | COM-01 |
...
| Social premium module | Disabled labeled placeholder only if future placement is approved | **Deferred** | COM-02 |
...
| Sponsored challenge | Stable disabled placeholder before ads approval; never required for baseline goals | **Deferred** | COM-03 |
| Season pass | Season identity/timer/XP, free and premium lanes, reward claim, expiry/migration | **Deferred** pending a separate economy/product approval; not an M13–M17 assumption | COM-04 |
| Legacy Gems mini-game | Match-game teaser/reward loop | **Deferred** until a real non-premium or approved currency purpose is defined | COM-05 |
...
|---|---|---|---|
| Currency store | Coin packs, bundle, remove-ads entitlement, cosmetics, restore purchases, legal/disclosure | Loading, localized pricing, unavailable product, pending, success, cancel, failure, already owned, restore none/success/failure, parental/age treatment, offline | **Deferred — COM-01** |
...
- an explicit rule that the alternate five-tab shell, action quota/`End Turn`, and Stim Coins are reference-only until a product decision changes the six-destination monthly loop.

## Delivery order

1. **M13:** finish shared component states, text containment, scrolling, restoration, Life compact modules, and the device/text/accessibility visual gate.
